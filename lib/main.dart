...
class LoginPageState extends State<LoginPage>  with AfterLayoutMixin<LoginPage> {
  ...
  Future<bool> _loginRequest(String username, String password) async {
    ...
    try {
      ...
      prefs.setString('logoProvinsi', '${hasilJSON['Pengguna']['logoProvinsi']}');
      prefs.setString('idKabupaten', '${hasilJSON['Pengguna']['idKabupaten']}');
      prefs.setString('kabupaten', '${hasilJSON['Pengguna']['kabupaten']}');
      prefs.setString('logoKabupaten', '${hasilJSON['Pengguna']['logoKabupaten']}');
  ...
  Future<bool> loginFacebookOauth() async {
    await loginFB.LoginFacebookUtility.apiLoginFacebook();
    try {
      SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  pasangParameterGlobals() async {
    SharedPreferences session = await SharedPreferences.getInstance();
    String hasil = "";
    hasil = await globals.Utility.ambilParameterGlobals(session.getString('userid'));
    try {
      Map<String, dynamic> hasilJson = json.decode(hasil);
      if('${hasilJson['Pengguna']['ingat_saya']}' == 'Ingat Saya' || '${hasilJson['Pengguna']['oauth_uid']}' != "") {
        globals.isLoggedIn = true;
          ...
          children: <Widget>[
            ...
            new Padding(
              ...
              child: new Row(
                ...
                children: <Widget>[
                  new TextButton(name: "Login Dengan Facebook", onPressed: loginFacebook),
                ],
              ),
            ),
            ...
            new Padding(
              ...
              child: new Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  new TextButton(name: "Check Global Parameter", onPressed: checkGlobalParameter),
                ],
              ),
            ),
            ...
            new Padding(
              ...
              child: new Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  new TextButton(name: "Buat Akun Baru", onPressed: pendaftaranAkun),
                  new TextButton(name: "Informasi Blubuk", onPressed: informasiBlubuk),
                ],
              ),
            )
          ],
