...
import 'package:blubuk/pengguna/grup/controller/listGrup.dart';


// ignore: must_be_immutable
class TampilanListGrup extends StatelessWidget {
  ListGrup listGrup;
  ListGrupState listGrupState;

  TampilanListGrup(this.listGrupState);
  ...
  Widget _buildProgressIndicator() {
    return new Padding(
      ...
      child: new Center(
        child: new Opacity(
          opacity: listGrupState.isPerformingRequest ? 1.0 : 0.0,
