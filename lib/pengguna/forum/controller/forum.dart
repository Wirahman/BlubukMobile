...
class Forum extends StatefulWidget {
  ...
  final String title;
  @override
  ForumState createState() => new ForumState();
}

class ForumState extends State<Forum> with TickerProviderStateMixin,ImagePickerListener {
  ...
  @override
  Widget build(BuildContext context) => new TampilanForum(this);
