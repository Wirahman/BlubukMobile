...
import 'package:Blubuk/pengguna/beranda/pesan.dart';
import 'package:Blubuk/pengguna/biografi/controller/biografi.dart';
import 'package:Blubuk/pengguna/forum/forum.dart';
import 'package:Blubuk/pengguna/teman/teman.dart';
...
class MenuState extends State<Menu> {
  ...
  _getDrawerItemWidget(int pos) {
    if (pos == 0) {
      ...
      // return new Text("Coba function Logout di class api atau menu");
      return logout();
    }else if (pos == 6) {
      checkSession();
